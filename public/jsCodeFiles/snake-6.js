...
JS_SNAKE.apple = function () {//
  ...
  function setNewPosition(snakeArray) {//
    ...
    if (JS_SNAKE.checkCoordinateInArray(newPosition, snakeArray)) { //if new position is already covered by the snake, try again
      return setNewPosition(snakeArray);//
    }//
    else {//otherwise set position to the new position
